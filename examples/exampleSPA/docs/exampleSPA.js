...
_Platform_export({'ExampleSPA':{'init':author$project$ExampleSPA$main(
	A2(
		...
		A2(elm$json$Json$Decode$field, 'width', elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.0"},"types":{"message":"ExampleSPA.Msg","aliases":{"ExampleSPA.MouseClickData":{"args":[],"type":"{ id1 : String.String, id2 : String.String, id3 : String.String, id4 : String.String, id5 : String.String }"}},"unions":{"ExampleSPA.Msg":{"args":[],"tags":{"MsgWidgetExample":["Widgets.WidgetExample.Msg"],"MsgOnPopState":["String.String"],"MsgClick":["ExampleSPA.MouseClickData"],"MsgChangePassword":["String.String"],"MsgChangeWindowSize":["Basics.Int","Basics.Int"]}},"Widgets.WidgetExample.Msg":{"args":[],"tags":{"MsgFormField":["Framework.FormField.Msg"],"MsgFormFieldWIdthPattern":["Framework.FormFieldWithPattern.Msg"],"MsgOnPopState":["String.String"],"MsgChangeWindowSize":["Basics.Int","Basics.Int"],"MsgOnChange":["Widgets.WidgetExample.Field","String.String"],"MsgOnFocus":["Widgets.WidgetExample.Field"],"MsgOnLoseFocus":["Widgets.WidgetExample.Field"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Framework.FormField.Msg":{"args":[],"tags":{"OnChange":["Framework.FormField.Field","String.String"],"OnFocus":["Framework.FormField.Field"],"OnLoseFocus":["Framework.FormField.Field"],"OnEnter":["Framework.FormField.Field"],"OnViewToggle":["Framework.FormField.Field"]}},"Framework.FormFieldWithPattern.Msg":{"args":[],"tags":{"Input":["Framework.FormFieldWithPattern.Field","String.String","String.String"],"OnFocus":["Framework.FormFieldWithPattern.Field"],"OnLoseFocus":["Framework.FormFieldWithPattern.Field"]}},"Widgets.WidgetExample.Field":{"args":[],"tags":{"Email":[]}},"Framework.FormField.Field":{"args":[],"tags":{"FieldEmail":[],"FieldText":[],"FieldUsername":[],"FieldNewPassword":[],"FieldCurrentPassword":[]}},"Framework.FormFieldWithPattern.Field":{"args":[],"tags":{"FieldTelephone":[],"FieldCreditCard":[],"Field6DigitCode":[]}}}}})}});}(this));