...
}var author$project$Framework$LinkClicked = function (a) {
	return {$: 'LinkClicked', a: a};
};
var author$project$Framework$UrlChanged = function (a) {
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'MsgStyleElementsInput':
				var msg2 = msg.a;
				var _n5 = A2(author$project$Framework$StyleElementsInput$update, msg2, model.modelStyleElementsInput);
				var newModel = _n5.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'MsgFormField':
				var msg2 = msg.a;
				var _n6 = A2(author$project$Framework$FormField$update, msg2, model.modelFormField);
				var newModel = _n6.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'MsgFormFieldWithPattern':
				var msg2 = msg.a;
				var _n7 = A2(author$project$Framework$FormFieldWithPattern$update, msg2, model.modelFormFieldWithPattern);
				var newModel = _n7.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			default:
				var msg2 = msg.a;
				var _n8 = A2(author$project$Framework$Card$update, msg2, model.modelCards);
				var newModel = _n8.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var author$project$Framework$initCmd = F3(
	function (_n0, _n1, _n2) {
...
var author$project$Framework$initModel = F3(
...
var author$project$FrameworkCustomized$init = F3(
	function (flags, url, key) {
		var initModel = A3(author$project$Framework$initModel, flags, url, key);
		return _Utils_Tuple2(
			_Utils_update(
				initModel,
				{conf: author$project$FrameworkCustomized$initConf, introspections: author$project$FrameworkCustomized$introspections}),
			A3(author$project$Framework$initCmd, flags, url, key));
	});
...
var author$project$Framework$viewDocument = function (model) {
	return {
		body: _List_fromArray(
			[
				author$project$Framework$view(model)
			]),
		title: '0.19 - Elm Style Framework'
	};
};
var author$project$FrameworkCustomized$viewDocument = author$project$Framework$viewDocument;
var elm$browser$Browser$application = _Browser_application;
var author$project$FrameworkCustomized$main = elm$browser$Browser$application(
	{init: author$project$FrameworkCustomized$init, onUrlChange: author$project$Framework$UrlChanged, onUrlRequest: author$project$Framework$LinkClicked, subscriptions: author$project$Framework$subscriptions, update: author$project$Framework$update, view: author$project$FrameworkCustomized$viewDocument});
