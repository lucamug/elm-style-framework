			...
			_elm_lang$html$Html_Attributes$style(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: A2(_elm_lang$core$Basics_ops['++'], '-webkit-', key),
						_1: value
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: A2(_elm_lang$core$Basics_ops['++'], '-moz-', key),
							_1: value
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: A2(_elm_lang$core$Basics_ops['++'], '-ms-', key),
								_1: value
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: A2(_elm_lang$core$Basics_ops['++'], '-o-', key),
									_1: value
								},
								_1: {
									ctor: '::',
				...
				})) : _mdgriffith$stylish_elephants$Element$htmlAttribute(
			_elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: key, _1: value},
...
var _lucamug$elm_style_framework$Framework_Cards$cardCommonAttr = {
	ctor: '::',
	_0: _mdgriffith$stylish_elephants$Element_Border$shadow(
		{
			blur: 10,
...
var _lucamug$elm_style_framework$Framework_Cards$simpleWithTitle = F3(
	function (title, subTitle, content) {
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_lucamug$elm_style_framework$Framework_Cards$cardCommonAttr,
				{
					ctor: '::',
					_0: _mdgriffith$stylish_elephants$Element_Border$width(1),
					_1: {
...
var _lucamug$elm_style_framework$Framework_Cards$flipping = function (data) {
	var y = _mdgriffith$stylish_elephants$Element$px(data.height);
	var x = _mdgriffith$stylish_elephants$Element$px(data.width);
	var commonAttr = A2(
		_elm_lang$core$Basics_ops['++'],
		_lucamug$elm_style_framework$Framework_Cards$cardCommonAttr,
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: A2(_lucamug$elm_style_framework$Framework_Cards$style, 'backface-visibility', 'hidden'),
					_1: {
						ctor: '::',
						_0: A2(_lucamug$elm_style_framework$Framework_Cards$style, 'position', 'absolute'),
						_1: {ctor: '[]'}
					}
				}
			}
	...
	variations: {
		...
		_0: {
			...
			_1: {
				...
				_0: {
					ctor: '_Tuple2',
					_0: _mdgriffith$stylish_elephants$Element$text('special: Cards.example1'),
					_1: ''
				},
				_1: {ctor: '[]'}
			}
...
var _lucamug$elm_style_framework$Framework_Cards$example1 = function (model) {
	...
	var commonAttr = {
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _mdgriffith$stylish_elephants$Element_Events$onClick(_lucamug$elm_style_framework$Framework_Cards$Flip),
				_1: {ctor: '[]'}
			}
		}
	};
	return {
		ctor: '_Tuple2',
		_0: _lucamug$elm_style_framework$Framework_Cards$flipping(
			{
				width: 200,
				height: 300,
					...
					A2(
						...
						contentAttr,
						{
							...
							_0: A2(
								...
								_mdgriffith$stylish_elephants$Element$text('Click Me')),
							_1: {
								ctor: '::',
								_0: A2(
									_mdgriffith$stylish_elephants$Element$el,
									...
									_mdgriffith$stylish_elephants$Element$text('Front')),
								_1: {ctor: '[]'}
							}
						})),
				back: A2(
					...
					A2(
						...
						{
							ctor: '::',
							_0: _mdgriffith$stylish_elephants$Element_Background$color(_elm_lang$core$Color$yellow),
							_1: {ctor: '[]'}
						}),
					A2(
						_mdgriffith$stylish_elephants$Element$column,
						contentAttr,
						{
							...
							_1: {
								...
								_0: A2(
									...
									_mdgriffith$stylish_elephants$Element$text('Back')),
								_1: {ctor: '[]'}
							}
						}))
			}),
		...
		},
		{
			...
			_0: A2(
				_elm_lang$svg$Svg$path,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$d('M0 0h100v100H0z'),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
			_1: {
					...
					_elm_lang$svg$Svg$circle,
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$fill('tomato'),
									_1: {ctor: '[]'}
								}
							}
						}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$fill('#1e90ff'),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$d('M7 75.6a49.8 49.8 0 0 0 67.2 18c-26-5.2-35.7-28.7-38-45.7-3.8.2-10.9 0-15.8.2-3 17-7.9 21-13.3 27.5z'),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
					_1: {
						...
						_0: A2(
							_elm_lang$svg$Svg$path,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$d('M3 43h15c4 0 4-5 0-5h-5c-1 0-1-1 0-1h22c4 0 4-5 0-5H7c-3 0-3 5 0 5h3c1 0 1 1 0 1H1.5l-1 5zm90.8 18l-15-.1c-4 0-4 5 0 5h5c1 0 1 1 0 1h-22c-4 0-4 5 0 5h28c3 0 3-5 0-5h-3c-1 0-1-1 0-1l10.6.1c.6-1.9 1-3 1.4-5zM20.2 47.6a47 47 0 0 1-7.6 21.5c4.4 3 8.9-15.5 10.1-15 1.7 0-2 12.7-.5 12.9 1.6-.1 2.8-8.3 4.8-8.3 1.8.3 2.3 9.1 4.1 8.7 1.9-.3 0-12.2 2-13.1 2-.2 5.1 16.3 9.7 14.8-3.7-7-5.7-14.7-6.7-21.4H20.2z'),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
...
var _lucamug$elm_style_framework$Framework$forkMe = _mdgriffith$stylish_elephants$Element$inFront(
	A2(
		_mdgriffith$stylish_elephants$Element$link,
		{
			ctor: '::',
...
var _lucamug$elm_style_framework$Framework$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'MsgCards':
				var _p11 = A2(_lucamug$elm_style_framework$Framework_Cards$update, _p0._0, model.modelCards);
...
var _lucamug$elm_style_framework$Framework$conf = {
	gray3: A4(_elm_lang$core$Color$rgba, 51, 51, 51, 255),
	gray9: A4(_elm_lang$core$Color$rgba, 153, 153, 153, 255),
	grayB: A4(_elm_lang$core$Color$rgba, 182, 182, 182, 255),
	grayD: A4(_elm_lang$core$Color$rgba, 209, 209, 209, 255),
	grayF: A4(_elm_lang$core$Color$rgba, 247, 247, 247, 255),
	title: A2(
		_mdgriffith$stylish_elephants$Element$column,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _mdgriffith$stylish_elephants$Element_Font$size(55),
						_1: {
							ctor: '::',
							_0: _mdgriffith$stylish_elephants$Element_Font$bold,
							_1: {
					...
					},
					{
						...
						_0: A2(
							...
							_mdgriffith$stylish_elephants$Element$text('elm')),
						_1: {
							ctor: '::',
							_0: _mdgriffith$stylish_elephants$Element$text('Style'),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
	...
	subTitle: 'FRAMEWORK',
	version: '0.0.1',
	introduction: _mdgriffith$stylish_elephants$Element$empty,
	mainPadding: 41,
	p: '1234'
};
var _lucamug$elm_style_framework$Framework$initModel = F2(
	function (flag, location) {
		return {
			...
			modelCards: _lucamug$elm_style_framework$Framework_Cards$initModel,
...
var _lucamug$elm_style_framework$Framework$viewTitleAndSubTitle = F2(
	function (title, subTitle) {
		return A2(
			...
			{
				ctor: '::',
				_0: _mdgriffith$stylish_elephants$Element_Background$color(_lucamug$elm_style_framework$Framework$conf.grayF),
				_1: {
					ctor: '::',
		...
		_mdgriffith$stylish_elephants$Element$paragraph,
		{
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _mdgriffith$stylish_elephants$Element_Font$color(_lucamug$elm_style_framework$Framework$conf.gray9),
						_1: {
							ctor: '::',
...
var _lucamug$elm_style_framework$Framework$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {selected: a, maybeWindowSize: b, modelStyleElementsInput: c, modelForm: d, modelCards: e, introspections: f, location: g, maybeWindowSize: h, p: i};
	});
var _lucamug$elm_style_framework$Framework$Flag = F2(
	function (a, b) {
		return {width: a, height: b};
	});
...
var _lucamug$elm_style_framework$Framework$MsgCards = function (a) {
	return {ctor: 'MsgCards', _0: a};
};
var _lucamug$elm_style_framework$Framework$specialComponentCards = F2(
	function (model, component) {
		...
		return {
			...
			_0: A2(
				...
				_lucamug$elm_style_framework$Framework$MsgCards,
...
var _lucamug$elm_style_framework$Framework$viewSubSection = F3(
	function (model, _p12, boxed) {
		...
		var _p14 = _elm_lang$core$Native_Utils.eq(
			...
			_p15,
			_mdgriffith$stylish_elephants$Element$text('special: example11')) ? A2(_lucamug$elm_style_framework$Framework$specialComponent, model, _lucamug$elm_style_framework$Framework_StyleElementsInput$example11) : {ctor: '_Tuple2', _0: _p15, _1: _p13._1})))))))))))))));
		var componentExampleToDisplay = _p14._0;
		var componentExampleSourceCodeToDisplay = _p14._1;
		return A2(
			_mdgriffith$stylish_elephants$Element$row,
			{ctor: '[]'},
			{
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					function (_p18) {
						var _p19 = _p18;
						return A3(_lucamug$elm_style_framework$Framework$viewIntrospectionBody, model, _p19._0, _p19._1);
					},
...
var _lucamug$elm_style_framework$Framework$viewSomething = F2(
	function (model, _p20) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _lucamug$elm_style_framework$Framework$viewIntrospectionTitle(_p21._0),
				_1: {
					ctor: '::',
					_0: A3(_lucamug$elm_style_framework$Framework$viewIntrospectionBody, model, _p21._1._0, _p21._1._1),
					_1: {ctor: '[]'}
				}
			});
	});
...
var _lucamug$elm_style_framework$Framework$viewContentColumn = function (model) {
	...
	if (_p22.ctor === 'Just') {
		return A2(_lucamug$elm_style_framework$Framework$viewSomething, model, _p22._0);
	} else {
		return A2(
			_mdgriffith$stylish_elephants$Element$el,
			{
					...
					_1: {
						...
						_0: A2(
							...
							A2(
								...
								function (_p23) {
									var _p24 = _p23;
									return A2(_lucamug$elm_style_framework$Framework$viewIntrospection, model, _p24._0);
								},
								model.introspections)),
						_1: {ctor: '[]'}
					}
								...
								_lucamug$elm_style_framework$Framework$MsgSelectThis(
									{
										ctor: '_Tuple2',
										_0: introspection,
										_1: {ctor: '_Tuple2', _0: _p27, _1: _p26._1}
									})),
							_1: {ctor: '[]'}
						}
					},
					_mdgriffith$stylish_elephants$Element$text(_p27));
			},
			variations);
	});
							...
							_elm_lang$core$Basics_ops['++'],
							{
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _mdgriffith$stylish_elephants$Element_Font$color(_lucamug$elm_style_framework$Framework$conf.grayD),
											_1: {
												ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					A2(
						...
						function (_p28) {
							var _p29 = _p28;
							return A2(_lucamug$elm_style_framework$Framework$viewIntrospectionForMenu, _p29._0, _p29._1);
						},
						model.introspections)),
				_1: {ctor: '[]'}
			}
	...
	function (maybeWindowSize, model) {
		return A2(
			_mdgriffith$stylish_elephants$Element$row,
			{
				...
				_0: _mdgriffith$stylish_elephants$Element$height(
					function () {
						var _p30 = maybeWindowSize;
						if (_p30.ctor === 'Just') {
							return _mdgriffith$stylish_elephants$Element$px(_p30._0.height);
						} else {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _lucamug$elm_style_framework$Framework$forkMe,
							_1: {ctor: '[]'}
						}
					}
				}
