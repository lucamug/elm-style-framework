...
var author$project$Color$fmod = F2(
	function (f, n) {
		var integer = elm_lang$core$Basics$floor(f);
...
var author$project$Color$hslToRgb = F3(
	function (hue, saturation, lightness) {
		var normHue = hue / elm_lang$core$Basics$degrees(60);
		var chroma = (1 - elm_lang$core$Basics$abs((2 * lightness) - 1)) * saturation;
		var m = lightness - (chroma / 2);
		var x = chroma * (1 - elm_lang$core$Basics$abs(
...
var author$project$Color$toRgb = function (color) {
	if (color.$ === 'RGBA') {
		...
		return {
			alpha: a,
			blue: elm_lang$core$Basics$round(255 * b),
			green: elm_lang$core$Basics$round(255 * g),
			red: elm_lang$core$Basics$round(255 * r)
		};
	}
};
		...
		A2(
			...
			_List_fromArray(
				[
					...
					mdgriffith$stylish_elephants$Element$Font$color(author$project$ColorElement$black)
				]),
			{
				label: A2(
...
var author$project$Color$withPrecedingHash = function (str) {
	return A2(elm_lang$core$String$startsWith, '#', str) ? str : A2(
		elm_lang$core$String$cons,
		_Utils_chr('#'),
		str);
};
...
var author$project$Color$fromStringHelp = F3(
	function (position, chars, accumulated) {
		...
		while (true) {
			if (!chars.b) {
				return elm_lang$core$Result$Ok(accumulated);
			} else {
				var _char = chars.a;
				var rest = chars.b;
				switch (_char.valueOf()) {
					...
					case '1':
						var $temp$position = position - 1,
							$temp$chars = rest,
							$temp$accumulated = accumulated + A2(elm_lang$core$Basics$pow, 16, position);
						position = $temp$position;
						chars = $temp$chars;
						accumulated = $temp$accumulated;
						continue fromStringHelp;
					case '2':
						var $temp$position = position - 1,
							$temp$chars = rest,
							$temp$accumulated = accumulated + (2 * A2(elm_lang$core$Basics$pow, 16, position));
						position = $temp$position;
						chars = $temp$chars;
						accumulated = $temp$accumulated;
						continue fromStringHelp;
					case '3':
						var $temp$position = position - 1,
							$temp$chars = rest,
							$temp$accumulated = accumulated + (3 * A2(elm_lang$core$Basics$pow, 16, position));
						position = $temp$position;
						chars = $temp$chars;
						accumulated = $temp$accumulated;
						continue fromStringHelp;
					case '4':
						var $temp$position = position - 1,
							$temp$chars = rest,
							$temp$accumulated = accumulated + (4 * A2(elm_lang$core$Basics$pow, 16, position));
						position = $temp$position;
						chars = $temp$chars;
						accumulated = $temp$accumulated;
						continue fromStringHelp;
					case '5':
						var $temp$position = position - 1,
							$temp$chars = rest,
							$temp$accumulated = accumulated + (5 * A2(elm_lang$core$Basics$pow, 16, position));
						position = $temp$position;
						chars = $temp$chars;
						accumulated = $temp$accumulated;
						continue fromStringHelp;
					case '6':
						var $temp$position = position - 1,
							$temp$chars = rest,
							$temp$accumulated = accumulated + (6 * A2(elm_lang$core$Basics$pow, 16, position));
						position = $temp$position;
						chars = $temp$chars;
						accumulated = $temp$accumulated;
						continue fromStringHelp;
					case '7':
						var $temp$position = position - 1,
							$temp$chars = rest,
							$temp$accumulated = accumulated + (7 * A2(elm_lang$core$Basics$pow, 16, position));
						position = $temp$position;
						chars = $temp$chars;
						accumulated = $temp$accumulated;
						continue fromStringHelp;
					case '8':
						var $temp$position = position - 1,
							$temp$chars = rest,
							$temp$accumulated = accumulated + (8 * A2(elm_lang$core$Basics$pow, 16, position));
						position = $temp$position;
						chars = $temp$chars;
						accumulated = $temp$accumulated;
						continue fromStringHelp;
					case '9':
						var $temp$position = position - 1,
							$temp$chars = rest,
							$temp$accumulated = accumulated + (9 * A2(elm_lang$core$Basics$pow, 16, position));
						position = $temp$position;
						chars = $temp$chars;
						accumulated = $temp$accumulated;
						continue fromStringHelp;
					case 'a':
						var $temp$position = position - 1,
							$temp$chars = rest,
							$temp$accumulated = accumulated + (10 * A2(elm_lang$core$Basics$pow, 16, position));
						position = $temp$position;
						chars = $temp$chars;
						accumulated = $temp$accumulated;
						continue fromStringHelp;
					case 'b':
						var $temp$position = position - 1,
							$temp$chars = rest,
							$temp$accumulated = accumulated + (11 * A2(elm_lang$core$Basics$pow, 16, position));
						position = $temp$position;
						chars = $temp$chars;
						accumulated = $temp$accumulated;
						continue fromStringHelp;
					case 'c':
						var $temp$position = position - 1,
							$temp$chars = rest,
							$temp$accumulated = accumulated + (12 * A2(elm_lang$core$Basics$pow, 16, position));
						position = $temp$position;
						chars = $temp$chars;
						accumulated = $temp$accumulated;
						continue fromStringHelp;
					case 'd':
						var $temp$position = position - 1,
							$temp$chars = rest,
							$temp$accumulated = accumulated + (13 * A2(elm_lang$core$Basics$pow, 16, position));
						position = $temp$position;
						chars = $temp$chars;
						accumulated = $temp$accumulated;
						continue fromStringHelp;
					case 'e':
						var $temp$position = position - 1,
							$temp$chars = rest,
							$temp$accumulated = accumulated + (14 * A2(elm_lang$core$Basics$pow, 16, position));
						position = $temp$position;
						chars = $temp$chars;
						accumulated = $temp$accumulated;
						continue fromStringHelp;
					case 'f':
						var $temp$position = position - 1,
							$temp$chars = rest,
							$temp$accumulated = accumulated + (15 * A2(elm_lang$core$Basics$pow, 16, position));
						position = $temp$position;
						chars = $temp$chars;
						accumulated = $temp$accumulated;
						continue fromStringHelp;
					default:
						...
						return elm_lang$core$Result$Err(
							elm_lang$core$String$fromChar(nonHex) + ' is not a valid hexadecimal character.');
				}
			}
		}
	});
...
var elm_lang$core$Result$mapError = F2(
	function (f, result) {
		if (result.$ === 'Ok') {
			var v = result.a;
			return elm_lang$core$Result$Ok(v);
		} else {
			var e = result.a;
			return elm_lang$core$Result$Err(
				f(e));
...
var author$project$Color$fromString = function (str) {
	if (elm_lang$core$String$isEmpty(str)) {
		return elm_lang$core$Result$Err('Empty strings are not valid hexadecimal strings.');
	} else {
		var result = function () {
			if (A2(elm_lang$core$String$startsWith, '-', str)) {
				var list = A2(
					elm_lang$core$Maybe$withDefault,
					_List_Nil,
					elm_lang$core$List$tail(
						elm_lang$core$String$toList(str)));
				return A2(
					elm_lang$core$Result$map,
					elm_lang$core$Basics$negate,
					A3(
						author$project$Color$fromStringHelp,
						elm_lang$core$List$length(list) - 1,
						list,
						0));
			} else {
				return A3(
					author$project$Color$fromStringHelp,
					elm_lang$core$String$length(str) - 1,
					elm_lang$core$String$toList(str),
					0);
			}
		}();
		...
		return A2(elm_lang$core$Result$mapError, formatError, result);
	}
};
...
var elm_lang$core$String$fromList = _String_fromList;
	...
	function (str, _n0, _n1, _n2, _n3) {
		...
		var toResult = function ($) {
			return author$project$Color$fromString(
				elm_lang$core$String$toLower(
					elm_lang$core$String$fromList($)));
		};
...
var author$project$Color$hex = function (str) {
	var withoutHash = A2(elm_lang$core$String$startsWith, '#', str) ? A2(elm_lang$core$String$dropLeft, 1, str) : str;
	var _n0 = elm_lang$core$String$toList(withoutHash);
	_n0$4:
	while (true) {
...
var elm_lang$core$Basics$turns = function (angleInTurns) {
	return (2 * elm_lang$core$Basics$pi) * angleInTurns;
};
var author$project$Color$hsla = F4(
	function (hue, saturation, lightness, alpha) {
		return A4(
			author$project$Color$HSLA,
			hue - elm_lang$core$Basics$turns(
				elm_lang$core$Basics$floor(hue / (2 * elm_lang$core$Basics$pi))),
			saturation,
			lightness,
			alpha);
	});
	...
	function (h, s, l) {
		return author$project$Color$colorToHex(
			A3(
				...
				elm_lang$core$Basics$degrees(h),
				s / 100,
				l / 100));
	});
...
var author$project$Framework$Configuration$getColor = function (key) {
	...
	var _n0 = A2(elm_lang$core$Debug$log, 'xxx', key);
	var _n1 = A2(elm_lang$core$Debug$log, 'xxx', value);
...
var author$project$Framework$Color$usageWrapper = function (cl) {
	return A2(
		...
		A2(mdgriffith$stylish_elephants$Element$column, _List_Nil, _List_Nil));
};
		...
		author$project$Framework$Card$flipping(
			{
				...
				back: A2(
					...
					_Utils_ap(
						...
						_List_fromArray(
							[
								mdgriffith$stylish_elephants$Element$Background$color(author$project$ColorElement$yellow)
							])),
					A2(
						mdgriffith$stylish_elephants$Element$column,
						contentAttr,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					mdgriffith$stylish_elephants$Element$Background$color(author$project$ColorElement$white)
				]),
			_List_fromArray(
				[
					A2(
				...
				mdgriffith$stylish_elephants$Element$layoutWith,
				{
					options: _List_fromArray(
						[
							...
							{
								backgroundColor: elm_lang$core$Maybe$Nothing,
								borderColor: elm_lang$core$Maybe$Just(
