...
{
	if (region.bP.aw === region.cf.aw)
	{
		return 'on line ' + region.bP.aw;
	}
	return 'on lines ' + region.bP.aw + ' through ' + region.cf.aw;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { d1: 'hidden', dy: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { d1: 'mozHidden', dy: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { d1: 'msHidden', dy: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { d1: 'webkitHidden', dy: 'webkitvisibilitychange' }
		: { d1: 'hidden', dy: 'visibilitychange' };
}
...
{
	var flags = 'g';
	if (options.cz) { flags += 'm'; }
	if (options.b4) { flags += 'i'; }
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {dX: fragment, co: host, cF: path, cH: port_, cK: protocol, cL: query};
	});
...
var elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {d8: index, eq: match, ev: number, fa: submatches};
	});
					...
					function () {
						switch (field) {
							case 0:
								return _Utils_update(
									model,
									{bU: removeCharactedAtTheEndIfNotNumbers});
							case 1:
								return _Utils_update(
									model,
									{bU: removeCharactedAtTheEndIfNotNumbers});
		...
		switch (msg.$) {
			...
			case 10:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							a7: elm$url$Url$fromString(locationHref)
						}),
					elm$core$Platform$Cmd$none);
			case 8:
				var password = msg.a;
			...
			case 0:
				...
				var toggle = function (_n3) {
					var data = _n3.a;
					var show = _n3.b;
					return _Utils_eq(data.o, dataName) ? _Utils_Tuple2(data, !show) : _Utils_Tuple2(data, show);
				};
				var intros = A2(elm$core$List$map, toggle, model.m);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{m: intros}),
			...
			case 5:
				var msg2 = msg.a;
				var _n5 = A2(author$project$Framework$FormField$update, msg2, model.ay);
				var newModel = _n5.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 6:
				var msg2 = msg.a;
				var _n6 = A2(author$project$Framework$FormFieldWithPattern$update, msg2, model.az);
				var newModel = _n6.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			default:
				var msg2 = msg.a;
				var _n7 = A2(author$project$Framework$Card$update, msg2, model.ax);
				var newModel = _n7.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var author$project$Color$toRgb = function (color) {
	if (!color.$) {
		...
		return {
			s: a,
			t: elm$core$Basics$round(255 * b),
			y: elm$core$Basics$round(255 * g),
			B: elm$core$Basics$round(255 * r)
		};
	}
};
...
var author$project$Color$toElementColor = function (color) {
	...
	return A4(
		...
		author$project$Color$toFloatNorm255(c.B),
		author$project$Color$toFloatNorm255(c.y),
		author$project$Color$toFloatNorm255(c.t),
		c.s);
};
...
var author$project$Framework$Logo$elmLogo = F2(
	function (type_, height) {
		...
		var c = function () {
			if (type_.$ === 1) {
				return {
					bp: author$project$Framework$Logo$cssRgb(0),
					bq: author$project$Framework$Logo$cssRgb(1),
					br: author$project$Framework$Logo$cssRgb(2),
					bs: author$project$Framework$Logo$cssRgb(3)
				};
			} else {
				var cl = type_.a;
				return {
					bp: author$project$Framework$Logo$cssRgb(cl),
					bq: author$project$Framework$Logo$cssRgb(cl),
					br: author$project$Framework$Logo$cssRgb(cl),
...
var mdgriffith$elm_ui$Internal$Style$classes = {c0: 'a', bl: 'atv', c2: 'ab', c3: 'cx', c4: 'cy', c5: 'acb', c6: 'accx', c7: 'accy', c8: 'acr', b0: 'al', b1: 'ar', c9: 'at', bm: 'ah', bn: 'av', db: 's', dg: 'bh', dh: 'b', dm: 'w7', dp: 'bd', dq: 'bdt', aS: 'bn', dr: 'bs', aT: 'cpe', dA: 'cp', dB: 'cpx', dC: 'cpy', F: 'c', aW: 'ctr', aX: 'cb', aY: 'ccx', G: 'ccy', ar: 'cl', aZ: 'cr', dG: 'ct', dH: 'cptr', dI: 'ctxt', at: 'fcs', dY: 'fs', d0: 'g', by: 'hbh', a2: 'hc', bz: 'hf', cn: 'hfp', d2: 'hv', d5: 'ic', d7: 'fr', eb: 'iml', ec: 'it', ed: 'i', ai: 'nb', cA: 'notxt', ew: 'ol', ex: 'or', X: 'oq', eD: 'oh', cD: 'pg', cE: 'p', eO: 'ppe', eU: 'ui', q: 'r', eW: 'sb', eX: 'sbx', eY: 'sby', eZ: 'sbt', e$: 'e', e0: 'cap', e2: 'sev', e8: 'sk', fd: 't', fe: 'tc', ff: 'w8', fg: 'w2', fh: 'w9', fi: 'tj', bg: 'tja', fj: 'tl', fk: 'w3', fl: 'w5', fm: 'w4', fn: 'tr', fo: 'w6', fp: 'w1', fq: 'tun', cU: 'ts', fw: 'clr', fz: 'u', bW: 'wc', cZ: 'we', bX: 'wf', c_: 'wfp', bZ: 'wrp'};
var mdgriffith$elm_ui$Internal$Model$columnClass = mdgriffith$elm_ui$Internal$Style$classes.db + (' ' + mdgriffith$elm_ui$Internal$Style$classes.F);
var mdgriffith$elm_ui$Internal$Model$gridClass = mdgriffith$elm_ui$Internal$Style$classes.db + (' ' + mdgriffith$elm_ui$Internal$Style$classes.d0);
var mdgriffith$elm_ui$Internal$Model$pageClass = mdgriffith$elm_ui$Internal$Style$classes.db + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cD);
var mdgriffith$elm_ui$Internal$Model$paragraphClass = mdgriffith$elm_ui$Internal$Style$classes.db + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cE);
var mdgriffith$elm_ui$Internal$Model$rowClass = mdgriffith$elm_ui$Internal$Style$classes.db + (' ' + mdgriffith$elm_ui$Internal$Style$classes.q);
var mdgriffith$elm_ui$Internal$Model$singleClass = mdgriffith$elm_ui$Internal$Style$classes.db + (' ' + mdgriffith$elm_ui$Internal$Style$classes.e$);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				elm$core$String$join,
				'-',
				A2(elm$core$List$map, mdgriffith$elm_ui$Internal$Model$lengthClassName, template.u)) + ('-space-x-' + (mdgriffith$elm_ui$Internal$Model$lengthClassName(template.e3.a) + ('-space-y-' + mdgriffith$elm_ui$Internal$Model$lengthClassName(template.e3.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + (elm$core$String$fromInt(pos.q) + ('-' + (elm$core$String$fromInt(pos.dF) + ('-' + (elm$core$String$fromInt(pos.ap) + ('-' + elm$core$String$fromInt(pos.T)))))));
		case 11:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					elm$core$Maybe$Just(
					elm$core$String$fromFloat(shadow.D) + 'px'),
					elm$core$Maybe$Just(
...
var mdgriffith$elm_ui$Internal$Model$renderFocusStyle = function (focus) {
	return A2(
		...
		mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.db) + (':focus .focusable, ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.db) + '.focusable:focus')),
		A2(
			elm$core$List$filterMap,
			elm$core$Basics$identity,
			_List_fromArray(
...
var mdgriffith$elm_ui$Internal$Style$baseSheet = _List_fromArray(
	[
		...
		A2(
		mdgriffith$elm_ui$Internal$Style$Class,
		mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.db) + ':focus',
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.d2, mdgriffith$elm_ui$Internal$Style$classes.fw)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.d2, mdgriffith$elm_ui$Internal$Style$classes.X)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.at, mdgriffith$elm_ui$Internal$Style$classes.fw)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.at, mdgriffith$elm_ui$Internal$Style$classes.X)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.bl, mdgriffith$elm_ui$Internal$Style$classes.fw)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.bl, mdgriffith$elm_ui$Internal$Style$classes.X)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				_List_fromArray(
					[
						...
						A2(
						mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + mdgriffith$elm_ui$Internal$Style$classes.c8,
						_List_fromArray(
							[
						...
						A2(
						mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + (mdgriffith$elm_ui$Internal$Style$classes.c8 + (' ~ s.' + mdgriffith$elm_ui$Internal$Style$classes.c6)),
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
				...
				_List_fromArray(
					[
						...
						A2(
						mdgriffith$elm_ui$Internal$Style$Child,
						's:first-of-type.' + mdgriffith$elm_ui$Internal$Style$classes.c7,
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + mdgriffith$elm_ui$Internal$Style$classes.c7,
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						mdgriffith$elm_ui$Internal$Style$Child,
						's:only-of-type.' + mdgriffith$elm_ui$Internal$Style$classes.c7,
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + (mdgriffith$elm_ui$Internal$Style$classes.c7 + ' ~ u'),
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
						A2(
						mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + (mdgriffith$elm_ui$Internal$Style$classes.c5 + (' ~ s.' + mdgriffith$elm_ui$Internal$Style$classes.c7)),
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
				...
				_List_fromArray(
					[
						...
						A2(
						mdgriffith$elm_ui$Internal$Style$Child,
						mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.db + ':first-child'),
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
						...
						mdgriffith$elm_ui$Internal$Style$Child,
						mdgriffith$elm_ui$Internal$Style$dot(
							mdgriffith$elm_ui$Internal$Style$classes.db + (mdgriffith$elm_ui$Internal$Style$selfName(3) + (':first-child + .' + mdgriffith$elm_ui$Internal$Style$classes.db))),
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
						...
						mdgriffith$elm_ui$Internal$Style$Child,
						mdgriffith$elm_ui$Internal$Style$dot(
							mdgriffith$elm_ui$Internal$Style$classes.db + (mdgriffith$elm_ui$Internal$Style$selfName(2) + (':first-child + .' + mdgriffith$elm_ui$Internal$Style$classes.db))),
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
...
var mdgriffith$elm_ui$Internal$Style$explainer = '\n.explain {\n    border: 6px solid rgb(174, 121, 15) !important;\n}\n.explain > .' + (mdgriffith$elm_ui$Internal$Style$classes.db + (' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n.ctr {\n    border: none !important;\n}\n.explain > .ctr > .' + (mdgriffith$elm_ui$Internal$Style$classes.db + ' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n')));
...
var mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.db) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.q) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.db) + (' { flex-basis: auto !important; } ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.db) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.q) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.db) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.aW) + (' { flex-basis: auto !important; }}' + (mdgriffith$elm_ui$Internal$Style$sliderOverrides + mdgriffith$elm_ui$Internal$Style$explainer))))))))))));
...
var mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aV: closing, f: _List_Nil, L: _List_Nil, C: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								f: A2(
									elm$core$List$cons,
									{aV: '\n}', f: _List_Nil, L: props, C: '@supports (' + (prop + (':' + (value + (') {' + parent.C))))},
									rendered.f)
							});
					case 4:
						var selector = rule.a;
...
var mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_n2.b) {
			...
			return rule.C + ('{' + (renderValues(rule.L) + (rule.aV + '}')));
		}
	};
	...
	function (name, modifier, _n0) {
		...
		return _List_fromArray(
			[
				...
				A2(mdgriffith$elm_ui$Internal$Model$bracket, '.' + (name + ('.' + (modifier + ('> .' + (mdgriffith$elm_ui$Internal$Style$classes.fd + (', .' + (name + (' .' + (modifier + (' > .' + mdgriffith$elm_ui$Internal$Style$classes.fd)))))))))), textAdjustment)
			]);
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.e0 + ('> .' + (mdgriffith$elm_ui$Internal$Style$classes.fd + (', .' + (name + (' .' + (mdgriffith$elm_ui$Internal$Style$classes.e0 + (' > .' + mdgriffith$elm_ui$Internal$Style$classes.fd)))))))))),
					_List_fromArray(
						[
...
var mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {T: height / size, D: size, cX: vertical};
	});
var mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.dx, adjustment.df, adjustment.dM, adjustment.ep]);
	var lineHeight = 1.5;
	...
	return {
		dx: A3(mdgriffith$elm_ui$Internal$Model$adjust, capitalSize, ascender - newBaseline, capitalVertical),
		cj: A3(mdgriffith$elm_ui$Internal$Model$adjust, fullSize, ascender - descender, fullVertical)
	};
};
	...
	return _Utils_Tuple2(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'line-height',
				elm$core$String$fromFloat(converted.T)),
				_Utils_Tuple2(
				'vertical-align',
				elm$core$String$fromFloat(converted.cX) + 'em'),
				_Utils_Tuple2(
				'font-size',
				elm$core$String$fromFloat(converted.D) + 'em')
			]));
};
					...
					switch (pseudo) {
						...
						case 0:
							...
							return A2(
								...
								'\n',
								_List_fromArray(
									[selector + ('-fs:focus {' + (renderedProps + '\n}')), '.' + (mdgriffith$elm_ui$Internal$Style$classes.db + (':focus ~ ' + (selector + ('-fs:not(.focus)  {' + (renderedProps + '\n}'))))), '.' + (mdgriffith$elm_ui$Internal$Style$classes.db + (':focus ' + (selector + ('-fs  {' + (renderedProps + '\n}'))))), '.focusable-parent:focus ~ ' + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.db + (' ' + (selector + ('-fs {' + (renderedProps + '\n}'))))))]));
						default:
			...
			function (rule, maybePseudo) {
				switch (rule.$) {
					...
					case 5:
						...
						var paragraph = '.' + mdgriffith$elm_ui$Internal$Style$classes.cE;
						...
						var _class = '.' + cls;
						var any = '.' + mdgriffith$elm_ui$Internal$Style$classes.db;
						return elm$core$String$concat(
							_List_fromArray(
								[
									A3(
					...
					case 9:
						...
						var modernPosition = A2(
							...
							_List_fromArray(
								[
									'grid-row: ' + (elm$core$String$fromInt(position.q) + (' / ' + (elm$core$String$fromInt(position.q + position.T) + ';'))),
									'grid-column: ' + (elm$core$String$fromInt(position.dF) + (' / ' + (elm$core$String$fromInt(position.dF + position.ap) + ';')))
								]));
						var _class = '.grid-pos-' + (elm$core$String$fromInt(position.q) + ('-' + (elm$core$String$fromInt(position.dF) + ('-' + (elm$core$String$fromInt(position.ap) + ('-' + elm$core$String$fromInt(position.T)))))));
					...
					A2(
						...
						A3(
							...
							_Utils_Tuple2(
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Internal$Model$renderFocusStyle(opts.at)
									])),
							styles).b)),
				children)) : A2(
			elm$core$List$cons,
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class(mdgriffith$elm_ui$Internal$Style$classes.db + (' ' + mdgriffith$elm_ui$Internal$Style$classes.e$))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.db, mdgriffith$elm_ui$Internal$Style$classes.e$, mdgriffith$elm_ui$Internal$Style$classes.aW, mdgriffith$elm_ui$Internal$Style$classes.G, mdgriffith$elm_ui$Internal$Style$classes.c8])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.db, mdgriffith$elm_ui$Internal$Style$classes.e$, mdgriffith$elm_ui$Internal$Style$classes.aW, mdgriffith$elm_ui$Internal$Style$classes.G, mdgriffith$elm_ui$Internal$Style$classes.c6])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.db, mdgriffith$elm_ui$Internal$Style$classes.e$, mdgriffith$elm_ui$Internal$Style$classes.aW, mdgriffith$elm_ui$Internal$Style$classes.c7])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.db, mdgriffith$elm_ui$Internal$Style$classes.e$, mdgriffith$elm_ui$Internal$Style$classes.aW, mdgriffith$elm_ui$Internal$Style$classes.c5])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.db, mdgriffith$elm_ui$Internal$Style$classes.fd, mdgriffith$elm_ui$Internal$Style$classes.bW, mdgriffith$elm_ui$Internal$Style$classes.a2])))
			]),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.db, mdgriffith$elm_ui$Internal$Style$classes.fd, mdgriffith$elm_ui$Internal$Style$classes.bX, mdgriffith$elm_ui$Internal$Style$classes.bz])))
			]),
		_List_fromArray(
			[
					...
					case 1:
						...
						return _Utils_eq(context, mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.d3, mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.ai, mdgriffith$elm_ui$Internal$Style$classes.e$, mdgriffith$elm_ui$Internal$Style$classes.c0]));
							case 1:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.ai, mdgriffith$elm_ui$Internal$Style$classes.e$, mdgriffith$elm_ui$Internal$Style$classes.dh]));
							case 2:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.ai, mdgriffith$elm_ui$Internal$Style$classes.e$, mdgriffith$elm_ui$Internal$Style$classes.ex]));
							case 3:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.ai, mdgriffith$elm_ui$Internal$Style$classes.e$, mdgriffith$elm_ui$Internal$Style$classes.ew]));
							case 4:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.ai, mdgriffith$elm_ui$Internal$Style$classes.e$, mdgriffith$elm_ui$Internal$Style$classes.d7]));
							default:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.ai, mdgriffith$elm_ui$Internal$Style$classes.e$, mdgriffith$elm_ui$Internal$Style$classes.dg]));
						}
					}())
				]),
			_List_fromArray(
				[
					...
					switch (elem.$) {
						...
						default:
							var styled = elem.a;
							return A2(styled.d3, mdgriffith$elm_ui$Internal$Model$NoStyleSheet, mdgriffith$elm_ui$Internal$Model$asEl);
					}
				}()
				]));
	});
...
var mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$elm_ui$Internal$Style$classes.bm + (' ' + mdgriffith$elm_ui$Internal$Style$classes.b0);
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.bm + (' ' + mdgriffith$elm_ui$Internal$Style$classes.b1);
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.bm + (' ' + mdgriffith$elm_ui$Internal$Style$classes.c3);
	}
};
var mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$elm_ui$Internal$Style$classes.bn + (' ' + mdgriffith$elm_ui$Internal$Style$classes.c9);
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.bn + (' ' + mdgriffith$elm_ui$Internal$Style$classes.c2);
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.bn + (' ' + mdgriffith$elm_ui$Internal$Style$classes.c4);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Internal$Style$classes.db + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.q + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
	...
	switch (w.$) {
		...
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_Nil) : _Utils_Tuple3(
				A2(mdgriffith$elm_ui$Internal$Flag$add, mdgriffith$elm_ui$Internal$Flag$widthFill, mdgriffith$elm_ui$Internal$Flag$none),
				mdgriffith$elm_ui$Internal$Style$classes.c_ + (' width-fill-' + elm$core$String$fromInt(portion)),
				_List_fromArray(
					[
						A3(
						mdgriffith$elm_ui$Internal$Model$Single,
							...
							switch (width.$) {
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.c_ + (' width-fill-' + elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											mdgriffith$elm_ui$Internal$Flag$add,
											mdgriffith$elm_ui$Internal$Flag$widthFill,
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.cn + (' height-fill-' + elm$core$String$fromInt(portion)))),
											...
											A3(
												mdgriffith$elm_ui$Internal$Model$Single,
												mdgriffith$elm_ui$Internal$Style$classes.db + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.F + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
													'height-fill-' + elm$core$String$fromInt(portion))))),
												'flex-grow',
												elm$core$String$fromInt(portion * 100000)),
											styles),
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								elm$core$List$cons,
								mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.aY + (' ' + mdgriffith$elm_ui$Internal$Style$classes.G)),
								attrs))))),
			mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
...
var author$project$Framework$initConf = {
	bu: mdgriffith$elm_ui$Element$inFront(
		A2(
				...
				]),
			{
				av: A2(
					...
					{as: 'Fork me on Github', e4: 'images/github.png'}),
				Z: 'https://github.com/lucamug/elm-style-framework'
			})),
	au: A3(author$project$Color$rgb, 51, 51, 51),
	a$: A3(author$project$Color$rgb, 153, 153, 153),
	bv: A3(author$project$Color$rgb, 182, 182, 182),
	bw: A3(author$project$Color$rgb, 209, 209, 209),
	bx: A3(author$project$Color$rgb, 247, 247, 247),
	cp: function (hostname) {
...
var author$project$Color$erroneousHex = function (str) {
	return {
		...
		y: 0,
		B: 0,
		bU: author$project$Color$withPrecedingHash(str)
	};
};
...
var author$project$Color$hexToColor = function (string) {
	...
	return A4(author$project$Color$rgba, c.B, c.y, c.t, c.s);
};
...
var author$project$Framework$Configuration$bulmaColor = {
	di: A3(author$project$Color$hsl2ToString, 0, 0, 4),
	dj: A3(author$project$Color$hsl2ToString, 0, 0, 7),
	dk: A3(author$project$Color$hsl2ToString, 0, 0, 14),
	t: A3(author$project$Color$hsl2ToString, 217, 71, 53),
	dJ: A3(author$project$Color$hsl2ToString, 204, 86, 53),
	y: A3(author$project$Color$hsl2ToString, 141, 71, 48),
	dZ: A3(author$project$Color$hsl2ToString, 0, 0, 48),
	d_: A3(author$project$Color$hsl2ToString, 0, 0, 29),
	d$: A3(author$project$Color$hsl2ToString, 0, 0, 21),
	ck: A3(author$project$Color$hsl2ToString, 0, 0, 71),
	cl: A3(author$project$Color$hsl2ToString, 0, 0, 86),
	eC: A3(author$project$Color$hsl2ToString, 14, 100, 53),
	eS: A3(author$project$Color$hsl2ToString, 271, 100, 71),
	B: A3(author$project$Color$hsl2ToString, 348, 100, 61),
	fx: A3(author$project$Color$hsl2ToString, 171, 100, 41),
	fD: A3(author$project$Color$hsl2ToString, 0, 0, 100),
	fE: A3(author$project$Color$hsl2ToString, 0, 0, 98),
	fF: A3(author$project$Color$hsl2ToString, 0, 0, 96),
	fH: A3(author$project$Color$hsl2ToString, 48, 100, 67)
};
var author$project$Framework$Configuration$bulmaSizes = {bM: '3.00', bN: '2.50', bO: '2.00', bb: '1.50', bc: '1.25', bd: '1.00', be: '0.75'};
...
var author$project$Framework$Configuration$configuration = elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2('black', author$project$Framework$Configuration$bulmaColor.di),
			_Utils_Tuple2('black_bis', author$project$Framework$Configuration$bulmaColor.dj),
			_Utils_Tuple2('black_ter', author$project$Framework$Configuration$bulmaColor.dk),
			_Utils_Tuple2('grey_darker', author$project$Framework$Configuration$bulmaColor.d$),
			_Utils_Tuple2('grey_dark', author$project$Framework$Configuration$bulmaColor.d_),
			_Utils_Tuple2('grey', author$project$Framework$Configuration$bulmaColor.dZ),
			_Utils_Tuple2('grey_light', author$project$Framework$Configuration$bulmaColor.ck),
			_Utils_Tuple2('grey_lighter', author$project$Framework$Configuration$bulmaColor.cl),
			_Utils_Tuple2('white_ter', author$project$Framework$Configuration$bulmaColor.fF),
			_Utils_Tuple2('white_bis', author$project$Framework$Configuration$bulmaColor.fE),
			_Utils_Tuple2('white', author$project$Framework$Configuration$bulmaColor.fD),
			_Utils_Tuple2('orange', author$project$Framework$Configuration$bulmaColor.eC),
			_Utils_Tuple2('yellow', author$project$Framework$Configuration$bulmaColor.fH),
			_Utils_Tuple2('green', author$project$Framework$Configuration$bulmaColor.y),
			_Utils_Tuple2('turquoise', author$project$Framework$Configuration$bulmaColor.fx),
			_Utils_Tuple2('cyan', author$project$Framework$Configuration$bulmaColor.dJ),
			_Utils_Tuple2('blue', author$project$Framework$Configuration$bulmaColor.t),
			_Utils_Tuple2('purple', author$project$Framework$Configuration$bulmaColor.eS),
			_Utils_Tuple2('red', author$project$Framework$Configuration$bulmaColor.B),
			...
			_Utils_Tuple2('size1', author$project$Framework$Configuration$bulmaSizes.bM),
			_Utils_Tuple2('size2', author$project$Framework$Configuration$bulmaSizes.bN),
			_Utils_Tuple2('size3', author$project$Framework$Configuration$bulmaSizes.bO),
			_Utils_Tuple2('size4', author$project$Framework$Configuration$bulmaSizes.bb),
			_Utils_Tuple2('size5', author$project$Framework$Configuration$bulmaSizes.bc),
			_Utils_Tuple2('size6', author$project$Framework$Configuration$bulmaSizes.bd),
			_Utils_Tuple2('size7', author$project$Framework$Configuration$bulmaSizes.be),
			_Utils_Tuple2('primary', author$project$Framework$Configuration$bulmaColor.fx),
			_Utils_Tuple2('info', author$project$Framework$Configuration$bulmaColor.dJ),
			_Utils_Tuple2('success', author$project$Framework$Configuration$bulmaColor.y),
			_Utils_Tuple2('warning', author$project$Framework$Configuration$bulmaColor.fH),
			_Utils_Tuple2('danger', author$project$Framework$Configuration$bulmaColor.B),
			_Utils_Tuple2('light', author$project$Framework$Configuration$bulmaColor.fF),
			_Utils_Tuple2('dark', author$project$Framework$Configuration$bulmaColor.d$),
			_Utils_Tuple2('background', author$project$Framework$Configuration$bulmaColor.fF),
			_Utils_Tuple2('border', author$project$Framework$Configuration$bulmaColor.cl),
			_Utils_Tuple2('border-hover', author$project$Framework$Configuration$bulmaColor.ck),
			_Utils_Tuple2('text', author$project$Framework$Configuration$bulmaColor.d_),
			_Utils_Tuple2('text-light', author$project$Framework$Configuration$bulmaColor.dZ),
			_Utils_Tuple2('text-strong', author$project$Framework$Configuration$bulmaColor.d$),
			_Utils_Tuple2('code', author$project$Framework$Configuration$bulmaColor.B),
			_Utils_Tuple2('code-background', author$project$Framework$Configuration$bulmaColor.fF),
			_Utils_Tuple2('pre', author$project$Framework$Configuration$bulmaColor.d_),
			_Utils_Tuple2('pre-background', author$project$Framework$Configuration$bulmaColor.fF),
			_Utils_Tuple2('link', author$project$Framework$Configuration$bulmaColor.t),
			_Utils_Tuple2(
			'link_invert',
			author$project$Framework$Configuration$findColorInvert(author$project$Framework$Configuration$bulmaColor.t)),
			_Utils_Tuple2('link_visited', author$project$Framework$Configuration$bulmaColor.eS),
			_Utils_Tuple2('link_hover', author$project$Framework$Configuration$bulmaColor.d$),
			_Utils_Tuple2('link_hover_border', author$project$Framework$Configuration$bulmaColor.ck),
			_Utils_Tuple2('link_focus', author$project$Framework$Configuration$bulmaColor.d$),
			_Utils_Tuple2('link_focus_border', author$project$Framework$Configuration$bulmaColor.t),
			_Utils_Tuple2('link_active', author$project$Framework$Configuration$bulmaColor.d$),
			_Utils_Tuple2('link_active_border', author$project$Framework$Configuration$bulmaColor.d_),
			_Utils_Tuple2('size_small', author$project$Framework$Configuration$bulmaSizes.be),
			_Utils_Tuple2('size_normal', author$project$Framework$Configuration$bulmaSizes.bd),
			_Utils_Tuple2('size_medium', author$project$Framework$Configuration$bulmaSizes.bc),
			_Utils_Tuple2('size_large', author$project$Framework$Configuration$bulmaSizes.bb),
			_Utils_Tuple2('moveDownPlaceHolderLarge', '31'),
			_Utils_Tuple2('moveDownPlaceHolderSmall', '30'),
			_Utils_Tuple2('transparent', '#ffffff00'),
			_Utils_Tuple2('muted', author$project$Framework$Configuration$bulmaColor.ck),
...
var author$project$Framework$Configuration$conf = {
	e: {
		dS: author$project$Framework$Configuration$getInt('buttonFontDefault'),
		dT: author$project$Framework$Configuration$getInt('buttonFontJumbo'),
		dU: author$project$Framework$Configuration$getInt('buttonFontLarge'),
		dV: author$project$Framework$Configuration$getInt('buttonFontMedium'),
		dW: author$project$Framework$Configuration$getInt('buttonFontSmall'),
		eE: author$project$Framework$Configuration$getInt('buttonPaddingXDefault'),
		eF: author$project$Framework$Configuration$getInt('buttonPaddingXJumbo'),
		eG: author$project$Framework$Configuration$getInt('buttonPaddingXLarge'),
		eH: author$project$Framework$Configuration$getInt('buttonPaddingXMedium'),
		eI: author$project$Framework$Configuration$getInt('buttonPaddingXSmall'),
		eJ: author$project$Framework$Configuration$getInt('buttonPaddingYDefault'),
		eK: author$project$Framework$Configuration$getInt('buttonPaddingYJumbo'),
		eL: author$project$Framework$Configuration$getInt('buttonPaddingYLarge'),
		eM: author$project$Framework$Configuration$getInt('buttonPaddingYMedium'),
		eN: author$project$Framework$Configuration$getInt('buttonPaddingYSmall')
	},
	g: {
		dd: author$project$Framework$Configuration$getColor('background'),
		di: author$project$Framework$Configuration$getColor('black'),
		dj: author$project$Framework$Configuration$getColor('black_bis'),
		dk: author$project$Framework$Configuration$getColor('black_ter'),
		t: author$project$Framework$Configuration$getColor('blue'),
		dn: author$project$Framework$Configuration$getColor('border'),
		ds: author$project$Framework$Configuration$getColor('border_hover'),
		dD: author$project$Framework$Configuration$getColor('code'),
		dE: author$project$Framework$Configuration$getColor('code_background'),
		dJ: author$project$Framework$Configuration$getColor('cyan'),
		dK: author$project$Framework$Configuration$getColor('danger'),
		dL: author$project$Framework$Configuration$getColor('dark'),
		y: author$project$Framework$Configuration$getColor('green'),
		dZ: author$project$Framework$Configuration$getColor('grey'),
		d_: author$project$Framework$Configuration$getColor('grey_dark'),
		d$: author$project$Framework$Configuration$getColor('grey_darker'),
		ck: author$project$Framework$Configuration$getColor('grey_light'),
		cl: author$project$Framework$Configuration$getColor('grey_lighter'),
		d9: author$project$Framework$Configuration$getColor('info'),
		ef: author$project$Framework$Configuration$getColor('light'),
		eg: author$project$Framework$Configuration$getColor('link'),
		eh: author$project$Framework$Configuration$getColor('link_active'),
		ei: author$project$Framework$Configuration$getColor('link_active_border'),
		ej: author$project$Framework$Configuration$getColor('link_focus'),
		ek: author$project$Framework$Configuration$getColor('link_focus_border'),
		el: author$project$Framework$Configuration$getColor('link_hover'),
		em: author$project$Framework$Configuration$getColor('link_hover_border'),
		en: author$project$Framework$Configuration$getColor('link_invert'),
		eo: author$project$Framework$Configuration$getColor('link_visited'),
		eu: author$project$Framework$Configuration$getColor('muted'),
		eC: author$project$Framework$Configuration$getColor('orange'),
		eP: author$project$Framework$Configuration$getColor('pre'),
		eQ: author$project$Framework$Configuration$getColor('pre_background'),
		eR: author$project$Framework$Configuration$getColor('primary'),
		eS: author$project$Framework$Configuration$getColor('purple'),
		B: author$project$Framework$Configuration$getColor('red'),
		fc: author$project$Framework$Configuration$getColor('success'),
		fd: author$project$Framework$Configuration$getColor('text'),
		fr: author$project$Framework$Configuration$getColor('text_light'),
		fs: author$project$Framework$Configuration$getColor('text_strong'),
		fw: author$project$Framework$Configuration$getColor('transparent'),
		fx: author$project$Framework$Configuration$getColor('turquoise'),
		fC: author$project$Framework$Configuration$getColor('warning'),
		fD: author$project$Framework$Configuration$getColor('white'),
		fE: author$project$Framework$Configuration$getColor('white_bis'),
		fF: author$project$Framework$Configuration$getColor('white_ter'),
		fH: author$project$Framework$Configuration$getColor('yellow')
	},
	a_: {
		cV: author$project$Framework$Configuration$getString('font_typeface'),
		fy: author$project$Framework$Configuration$getTypeface('font_typeface_fallback'),
		Z: author$project$Framework$Configuration$getString('font_url')
	},
	et: {
		ee: author$project$Framework$Configuration$getFloat('moveDownPlaceHolderLarge'),
		e1: author$project$Framework$Configuration$getFloat('moveDownPlaceHolderSmall')
	},
	D: {
		bM: author$project$Framework$Configuration$getFloat('size1'),
		bN: author$project$Framework$Configuration$getFloat('size2'),
		bO: author$project$Framework$Configuration$getFloat('size3'),
		bb: author$project$Framework$Configuration$getFloat('size4'),
		bc: author$project$Framework$Configuration$getFloat('size5'),
		bd: author$project$Framework$Configuration$getFloat('size6'),
		be: author$project$Framework$Configuration$getFloat('size7')
	}
};
var author$project$Framework$Color$grey_lighter = author$project$Framework$Configuration$conf.g.cl;
var author$project$Framework$Button$colorBorderDefault = author$project$Framework$Color$grey_lighter;
var author$project$Framework$Color$white = author$project$Framework$Configuration$conf.g.fD;
...
var author$project$Framework$Color$danger = author$project$Framework$Configuration$conf.g.dK;
var author$project$Framework$Color$info = author$project$Framework$Configuration$conf.g.d9;
var author$project$Framework$Color$muted = author$project$Framework$Configuration$conf.g.eu;
var author$project$Framework$Color$primary = author$project$Framework$Configuration$conf.g.eR;
var author$project$Framework$Color$success = author$project$Framework$Configuration$conf.g.fc;
var author$project$Framework$Color$warning = author$project$Framework$Configuration$conf.g.fC;
...
var author$project$Framework$Button$toButtonPadding = function (size) {
	switch (size) {
		case 0:
			return _Utils_Tuple2(author$project$Framework$Configuration$conf.e.eI, author$project$Framework$Configuration$conf.e.eN);
		case 1:
			return _Utils_Tuple2(author$project$Framework$Configuration$conf.e.eE, author$project$Framework$Configuration$conf.e.eJ);
		case 2:
			return _Utils_Tuple2(author$project$Framework$Configuration$conf.e.eH, author$project$Framework$Configuration$conf.e.eM);
		case 3:
			return _Utils_Tuple2(author$project$Framework$Configuration$conf.e.eG, author$project$Framework$Configuration$conf.e.eL);
		default:
			return _Utils_Tuple2(author$project$Framework$Configuration$conf.e.eF, author$project$Framework$Configuration$conf.e.eK);
	}
};
var author$project$Framework$Button$toPx = function (size) {
	switch (size) {
		case 0:
			return author$project$Framework$Configuration$conf.e.dW;
		case 1:
			return author$project$Framework$Configuration$conf.e.dS;
		case 2:
			return author$project$Framework$Configuration$conf.e.dV;
		case 3:
			return author$project$Framework$Configuration$conf.e.dU;
		default:
			return author$project$Framework$Configuration$conf.e.dT;
	}
};
var author$project$Framework$Color$disabledButtonBackground = author$project$Framework$Configuration$conf.g.cl;
var author$project$Framework$Color$disabledButtonFont = author$project$Framework$Configuration$conf.g.ck;
var author$project$Framework$Color$grey_dark = author$project$Framework$Configuration$conf.g.d_;
var author$project$Framework$Color$transparent = author$project$Framework$Configuration$conf.g.fw;
...
var author$project$Framework$Button$buttonAttr = function (modifiers) {
	var confButton = A3(
		...
		{g: author$project$Framework$Button$colorDefault, D: 1, i: 0},
		modifiers);
	var fontSize = author$project$Framework$Button$toPx(confButton.D);
	...
	var buttonPadding = author$project$Framework$Button$toButtonPadding(confButton.D);
	var borderRounded = function () {
		var _n3 = confButton.D;
		if (!_n3) {
			return 2;
		} else {
			return 3;
...
var mdgriffith$elm_ui$Element$pointer = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$cursor, mdgriffith$elm_ui$Internal$Style$classes.dH);
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						elm$core$List$cons,
						mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.aY + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.G + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.eZ + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cA)))))),
						A2(
							elm$core$List$cons,
...
var author$project$Framework$Button$button = F3(
	function (modifiers, onPress, label) {
		return A2(
			...
			{
				av: mdgriffith$elm_ui$Element$text(label),
				aj: onPress
			});
	});
...
var mdgriffith$elm_ui$Element$Font$center = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontAlignment, mdgriffith$elm_ui$Internal$Style$classes.fe);
...
var mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				elm$core$List$cons,
				mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.ar + (' ' + mdgriffith$elm_ui$Internal$Style$classes.G)),
				A2(
					elm$core$List$cons,
					mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$shrink),
					A2(
...
var author$project$Framework$Button$introspection = function () {
	...
	return {
		as: 'Buttons accept a list of modifiers, a Maybe msg (for example: \"Just DoSomething\") and the text to display inside the button.',
		o: 'Buttons',
		aF: 'List Modifier -> Maybe msg -> String -> Element msg',
		an: _List_fromArray(
			[
				_Utils_Tuple2(
				'States',
						...
						A2(
							...
							author$project$Framework$Button$buttonAttr(
								_List_fromArray(
									[1])),
							{
								av: mdgriffith$elm_ui$Element$text('button'),
...
var mdgriffith$elm_ui$Element$Border$shadow = function (almostShade) {
	var shade = {b3: almostShade.b3, g: almostShade.g, cr: false, cB: almostShade.cB, D: almostShade.D};
	return A2(
		mdgriffith$elm_ui$Internal$Model$StyleClass,
...
var author$project$Framework$Card$cardCommonAttr = _List_fromArray(
	[
		...
		{
			b3: 10,
			g: author$project$Color$toElementColor(
				A4(author$project$Color$rgba, 0, 0, 0, 5.0e-2)),
			cB: _Utils_Tuple2(0, 2),
			D: 1
		}),
		mdgriffith$elm_ui$Element$Border$width(1),
		mdgriffith$elm_ui$Element$Border$color(
...
var author$project$Framework$Color$grey = author$project$Framework$Configuration$conf.g.dZ;
var author$project$Framework$Color$grey_light = author$project$Framework$Configuration$conf.g.ck;
...
var author$project$Framework$Card$normal = function (_n0) {
	var colorBackground = _n0.b7;
	var colorFont = _n0.ca;
	var colorFontSecondary = _n0.cb;
	var colorBorder = _n0.b8;
	var colorBorderSecondary = _n0.b9;
	var colorShadow = _n0.cc;
	var extraAttributes = _n0.ch;
	var title = _n0.bh;
	var subTitle = _n0.bf;
	var content = _n0.cd;
	return A2(
			...
			_Utils_ap(
				_List_fromArray(
					[
						...
						{
							b3: 10,
							g: author$project$Color$toElementColor(colorShadow),
							cB: _Utils_Tuple2(0, 2),
							D: 1
						})
					]),
...
var author$project$Framework$Card$simpleWithTitle = F3(
	function (title, subTitle, content) {
		return author$project$Framework$Card$normal(
			{
				b7: author$project$Framework$Color$white,
				b8: author$project$Framework$Color$grey_light,
				b9: author$project$Framework$Color$grey_light,
				ca: author$project$Framework$Color$grey,
				cb: author$project$Framework$Color$grey_light,
				cc: A4(author$project$Color$rgba, 0, 0, 0, 5.0e-2),
				cd: content,
				ch: _List_Nil,
				bf: subTitle,
				bh: title
...
var author$project$Framework$Color$background = author$project$Framework$Configuration$conf.g.dd;
var author$project$Framework$Color$black = author$project$Framework$Configuration$conf.g.di;
var author$project$Framework$Color$black_bis = author$project$Framework$Configuration$conf.g.dj;
var author$project$Framework$Color$black_ter = author$project$Framework$Configuration$conf.g.dk;
var author$project$Framework$Color$blue = author$project$Framework$Configuration$conf.g.t;
var author$project$Framework$Color$border = author$project$Framework$Configuration$conf.g.dn;
var author$project$Framework$Color$border_hover = author$project$Framework$Configuration$conf.g.ds;
var author$project$Framework$Color$code = author$project$Framework$Configuration$conf.g.dD;
var author$project$Framework$Color$code_background = author$project$Framework$Configuration$conf.g.dE;
var author$project$Framework$Color$cyan = author$project$Framework$Configuration$conf.g.dJ;
var author$project$Framework$Color$dark = author$project$Framework$Configuration$conf.g.dL;
var author$project$Framework$Color$green = author$project$Framework$Configuration$conf.g.y;
var author$project$Framework$Color$grey_darker = author$project$Framework$Configuration$conf.g.d$;
var author$project$Framework$Color$light = author$project$Framework$Configuration$conf.g.ef;
var author$project$Framework$Color$link = author$project$Framework$Configuration$conf.g.eg;
var author$project$Framework$Color$link_active = author$project$Framework$Configuration$conf.g.eh;
var author$project$Framework$Color$link_active_border = author$project$Framework$Configuration$conf.g.ei;
var author$project$Framework$Color$link_focus = author$project$Framework$Configuration$conf.g.ej;
var author$project$Framework$Color$link_focus_border = author$project$Framework$Configuration$conf.g.ek;
var author$project$Framework$Color$link_hover = author$project$Framework$Configuration$conf.g.el;
var author$project$Framework$Color$link_hover_border = author$project$Framework$Configuration$conf.g.em;
var author$project$Framework$Color$link_invert = author$project$Framework$Configuration$conf.g.en;
var author$project$Framework$Color$link_visited = author$project$Framework$Configuration$conf.g.eo;
var author$project$Framework$Color$orange = author$project$Framework$Configuration$conf.g.eC;
var author$project$Framework$Color$pre = author$project$Framework$Configuration$conf.g.eP;
var author$project$Framework$Color$pre_background = author$project$Framework$Configuration$conf.g.eQ;
var author$project$Framework$Color$purple = author$project$Framework$Configuration$conf.g.eS;
var author$project$Framework$Color$red = author$project$Framework$Configuration$conf.g.B;
var author$project$Framework$Color$text = author$project$Framework$Configuration$conf.g.fd;
var author$project$Framework$Color$text_light = author$project$Framework$Configuration$conf.g.fr;
var author$project$Framework$Color$text_strong = author$project$Framework$Configuration$conf.g.fs;
var author$project$Framework$Color$turquoise = author$project$Framework$Configuration$conf.g.fx;
var author$project$Color$intensity = function (c) {
	var c2 = author$project$Color$toRgb(c);
	return ((c2.B * 0.299) + (c2.y * 0.587)) + (c2.t * 0.114);
};
...
var author$project$Framework$Color$white_bis = author$project$Framework$Configuration$conf.g.fE;
var author$project$Framework$Color$white_ter = author$project$Framework$Configuration$conf.g.fF;
var author$project$Framework$Color$yellow = author$project$Framework$Configuration$conf.g.fH;
...
var author$project$Framework$FormField$introspection = {
	as: 'List of elements for Web Forms',
	o: 'Fields',
	aF: '',
	an: _List_fromArray(
		[
...
var author$project$Framework$Icon$introspection = {
	as: 'List of SVG icons',
	o: 'Icons',
	aF: 'Color.Color -> Int -> Element.Element msg',
	an: _List_fromArray(
		[
			_Utils_Tuple2(
			'Icons',
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A2(
									elm$core$List$cons,
									mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.G),
									attrs)))))),
			mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
...
var author$project$Framework$StyleElements$introspection = {
	as: 'This is a raw list of all elements of style-elements as they are',
	o: 'Style-Elements',
	aF: '',
	an: _List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					A2(
						...
						_List_Nil,
						{
							av: mdgriffith$elm_ui$Element$text('link'),
							Z: 'http://example.com'
						}),
					...
					A2(
						...
						_List_Nil,
						{
							av: mdgriffith$elm_ui$Element$text('newTabLink'),
							Z: 'http://example.com'
						}),
					...
					A2(
						...
						_List_Nil,
						{
							av: mdgriffith$elm_ui$Element$text('download'),
							Z: 'http://example.com'
						}),
					...
					A2(
						...
						{
							dQ: 'filename',
							av: mdgriffith$elm_ui$Element$text('downloadAs'),
							Z: 'http://example.com'
						}),
					...
					A2(
						mdgriffith$elm_ui$Element$image,
						_List_Nil,
						{as: 'description', e4: 'http://via.placeholder.com/200x100/ff3399/000'}),
...
var author$project$Framework$Typography$introspection = {
	as: '',
	o: 'Typography',
	aF: 'List (Element.Attribute msg) -> Element.Element msg -> Element.Element msg',
	an: _List_fromArray(
		[
			_Utils_Tuple2(
			'Heading',
...
var author$project$Framework$FormField$initModel = {H: elm$core$Maybe$Nothing, x: elm$core$Maybe$Nothing, aN: '', aO: false, aP: '', aQ: '', aR: false, _: '', bV: ''};
var author$project$Framework$FormFieldWithPattern$initModel = {at: elm$core$Maybe$Nothing, bU: ''};
var author$project$Framework$StyleElementsInput$initModel = {
	aU: false,
	aC: elm$core$Maybe$Just('A'),
	fd: ''
};
var author$project$Framework$initModel = function (flags) {
	return {
		a: author$project$Framework$initConf,
		m: author$project$Framework$debug ? author$project$Framework$introspections : author$project$Framework$introspectionsForDebugging,
		a7: elm$url$Url$fromString(flags.bC),
		a8: elm$core$Maybe$Just(
			{T: flags.T, ap: flags.ap}),
		ax: author$project$Framework$Card$initModel,
		ay: author$project$Framework$FormField$initModel,
		az: author$project$Framework$FormFieldWithPattern$initModel,
...
var author$project$FrameworkCustomized$initConf = function () {
	...
	return _Utils_update(
		confData,
		{
			bu: mdgriffith$elm_ui$Element$inFront(mdgriffith$elm_ui$Element$none),
			cp: function (_n0) {
				return true;
			},
			bA: A2(
			...
			bh: A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								{o: 'Archivo Black', Z: 'https://fonts.googleapis.com/css?family=Archivo+Black'}),
				...
				_List_fromArray(
					[
						...
						{
							av: A2(author$project$FrameworkCustomized$Logo$logo, 0, 120),
							Z: '..'
						}),
						A2(
						mdgriffith$elm_ui$Element$el,
...
var author$project$FrameworkCustomized$Logo$introspection = {
	as: 'List of SVG logos',
	o: 'Logo Massive Dynamics',
	aF: 'Logo -> Int -> Element.Element msg',
	an: _List_fromArray(
		[
			_Utils_Tuple2(
			'Logo',
...
var author$project$FrameworkCustomized$init = function (flags) {
	...
	return _Utils_Tuple2(
		_Utils_update(
			initModel,
			{a: author$project$FrameworkCustomized$initConf, m: author$project$FrameworkCustomized$introspections}),
...
var author$project$Framework$emptyIntrospection = {as: '', o: 'Not found', aF: '', an: _List_Nil};
...
var elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {R: frag, Y: params, M: unvisited, bU: value, aa: visited};
	});
...
var elm$url$Url$Parser$getFirstMatch = function (states) {
	...
	while (true) {
		if (!states.b) {
			...
			var _n1 = state.M;
			if (!_n1.b) {
				return elm$core$Maybe$Just(state.bU);
			} else {
				if ((_n1.a === '') && (!_n1.b.b)) {
					return elm$core$Maybe$Just(state.bU);
				} else {
		...
		return elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					elm$url$Url$Parser$State,
					_List_Nil,
					elm$url$Url$Parser$preparePath(url.cF),
					elm$url$Url$Parser$prepareQuery(url.cL),
					url.dX,
					elm$core$Basics$identity)));
	});
...
var author$project$Framework$maybeSelected = function (model) {
	var _n0 = function () {
		var _n1 = author$project$Framework$routeFromMaybeUrl(model.a7);
		if (_n1.$ === 1) {
			var slug3 = _n1.a;
			var slug4 = _n1.b;
			return _Utils_Tuple2(
		...
		elm$core$List$head(
			A2(
				...
				function (_n3) {
					...
					return _Utils_eq(introspection2.o, slug1);
				},
				model.m)));
...
var mdgriffith$elm_ui$Element$clip = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$overflow, mdgriffith$elm_ui$Internal$Style$classes.dA);
var mdgriffith$elm_ui$Element$scrollbars = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$overflow, mdgriffith$elm_ui$Internal$Style$classes.eW);
	...
	function (configuration, sourceCode) {
		return A2(
			...
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$Background$color(
					author$project$Color$toElementColor(configuration.au)),
			...
			A2(
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Element$Font$color(
						author$project$Color$toElementColor(configuration.a$)),
...
var author$project$Framework$specialComponentFormFieldWithPattern = F2(
	function (model, component) {
		var componentTuplet = component(model.az);
		return _Utils_Tuple2(
...
var author$project$Framework$Card$flipping = function (data) {
	var y = mdgriffith$elm_ui$Element$px(data.T);
	var x = mdgriffith$elm_ui$Element$px(data.ap);
				...
				_Utils_ap(
					...
					_Utils_ap(
						...
						_Utils_ap(
							...
							data.b_ ? A2(author$project$Framework$Card$stylexxx, 'transform', 'rotateY(0deg)') : A2(author$project$Framework$Card$stylexxx, 'transform', 'rotateY(180deg)')))),
				_List_fromArray(
					[
						A2(
						mdgriffith$elm_ui$Element$el,
...
var author$project$Framework$FormField$labelBuilder = function (_n0) {
	var maybeFieldFocused = _n0.U;
	var field = _n0.w;
	var fieldValue = _n0.Q;
	var label = _n0.av;
...
var author$project$Framework$FormField$inputFieldParameterForText = function (conf) {
	return {
		av: author$project$Framework$FormField$labelBuilder(conf),
		bI: conf.af(conf.w),
...
var author$project$Framework$FormField$attrs = function (_n0) {
	var msgOnFocus = _n0.ag;
	var msgOnLoseFocus = _n0.ah;
	var maybeMsgOnEnter = _n0.ae;
	var inputTypeAttrs = _n0.I;
	var field = _n0.w;
	var maybeFieldFocused = _n0.U;
	var focused = function () {
		if (maybeFieldFocused.$ === 1) {
...
var mdgriffith$elm_ui$Element$Input$textHelper = F3(
	function (textInput, attrs, textOptions) {
		...
		var behavior = _List_fromArray(
			[
				mdgriffith$elm_ui$Internal$Model$Attr(
				elm$html$Html$Events$onInput(textOptions.bI))
			]);
			...
			if (!_n1.$) {
				...
				return _Utils_Tuple3(
					...
					_Utils_ap(
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$Input$value(textOptions.fd),
								mdgriffith$elm_ui$Internal$Model$Attr(
								elm$html$Html$Attributes$type_(inputType)),
								mdgriffith$elm_ui$Element$Input$spellcheck(textInput.n),
				...
				var _n3 = A3(
					...
					{j: _List_Nil, a2: elm$core$Maybe$Nothing, a4: elm$core$Maybe$Nothing, a5: elm$core$Maybe$Nothing, a6: elm$core$Maybe$Nothing},
					attributes);
				var maybePadding = _n3.a5;
				var heightContent = _n3.a2;
				var maybeSpacing = _n3.a6;
				var adjustedAttributes = _n3.j;
				var maybeBorder = _n3.a4;
				...
				return _Utils_Tuple3(
							...
							[
								...
								if (maybePadding.$ === 1) {
									...
									return mdgriffith$elm_ui$Element$paddingEach(
										{
											bo: A2(elm$core$Basics$max, 0, b - ((spacing / 2) | 0)),
											bB: l,
											bL: r,
											bT: A2(elm$core$Basics$max, 0, t - ((spacing / 2) | 0))
										});
								}
							}(),
								function () {
								if (heightContent.$ === 1) {
									...
									if (heightContent.a) {
										return A4(mdgriffith$elm_ui$Element$Input$textHeightContent, textOptions.fd, spacing, maybePadding, maybeBorder);
									} else {
										return mdgriffith$elm_ui$Internal$Model$NoAttribute;
									}
								}
					...
					_List_fromArray(
						[
							...
							elm$html$Html$text(textOptions.fd))
						]));
			}
		}();
		var inputNode = _n0.a;
													...
													_Utils_ap(
														_List_fromArray(
															[
																...
																mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.cA + (' ' + mdgriffith$elm_ui$Internal$Style$classes.eO)),
																mdgriffith$elm_ui$Element$Border$color(
		...
		return A3(
			...
			A2(
				elm$core$List$cons,
				A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$cursor, mdgriffith$elm_ui$Internal$Style$classes.dI),
				A2(
					elm$core$List$cons,
	...
	return _Utils_Tuple2(
		A2(
				...
				]),
			{
				w: 1,
				Q: model._,
				ac: A3(author$project$Framework$FormField$newHelperText, model.H, 1, model._),
				ad: mdgriffith$elm_ui$Element$Input$text,
				I: _List_Nil,
				av: A2(
					mdgriffith$elm_ui$Element$row,
					_List_fromArray(
				...
				U: model.x,
				ae: elm$core$Maybe$Just(author$project$Framework$FormField$OnEnter),
				af: author$project$Framework$FormField$OnChange,
				ag: author$project$Framework$FormField$OnFocus,
				ah: author$project$Framework$FormField$OnLoseFocus
			}),
...
var mdgriffith$elm_ui$Element$Input$email = mdgriffith$elm_ui$Element$Input$textHelper(
	{
		l: elm$core$Maybe$Just('email'),
		n: false,
		r: mdgriffith$elm_ui$Element$Input$TextInputNode('email')
	});
	...
	return _Utils_Tuple2(
		A2(
				...
				]),
			{
				w: 0,
				Q: model.aP,
				ac: A3(author$project$Framework$FormField$newHelperText, model.H, 0, model.aP),
				ad: mdgriffith$elm_ui$Element$Input$email,
				I: _List_Nil,
				av: mdgriffith$elm_ui$Element$text('Email'),
				U: model.x,
				ae: elm$core$Maybe$Just(author$project$Framework$FormField$OnEnter),
				af: author$project$Framework$FormField$OnChange,
				ag: author$project$Framework$FormField$OnFocus,
...
var author$project$Framework$FormField$inputFieldParameterForPassword = F2(
	function (conf, show) {
		...
		return {av: temp.av, bI: temp.bI, bJ: temp.bJ, aE: show, fd: temp.fd};
	});
var author$project$Framework$FormField$inputPassword = F2(
	function (mainAttrs, conf) {
						...
						A2(
							...
							_List_fromArray(
								[
									...
									showHidePassword.cy(conf.w)),
									mdgriffith$elm_ui$Element$pointer
								]),
							function () {
								if (conf.aE) {
									var _n1 = showHidePassword.cv;
									if (!_n1.$) {
										var icon = _n1.a;
										return icon;
									} else {
		...
		var newConf = _Utils_update(
			conf,
			{
				I: _Utils_ap(conf.I, extraAttr)
			});
		return A3(
			author$project$Framework$FormField$inputGeneric,
			mainAttrs,
			newConf,
			A2(author$project$Framework$FormField$inputFieldParameterForPassword, newConf, newConf.aE));
	});
...
var author$project$Framework$FormField$maybeShowHidePassword = elm$core$Maybe$Just(
	{cv: elm$core$Maybe$Nothing, cw: elm$core$Maybe$Nothing, cy: author$project$Framework$FormField$OnViewToggle});
var mdgriffith$elm_ui$Element$Input$newPassword = F2(
	function (attrs, pass) {
		return A3(
			mdgriffith$elm_ui$Element$Input$textHelper,
			{
				l: elm$core$Maybe$Just('new-password'),
				n: false,
				r: mdgriffith$elm_ui$Element$Input$TextInputNode(
					pass.aE ? 'text' : 'password')
			},
			attrs,
			{av: pass.av, bI: pass.bI, bJ: pass.bJ, fd: pass.fd});
	});
	...
	return _Utils_Tuple2(
		A2(
				...
				]),
			{
				w: 3,
				Q: model.aQ,
				ac: A3(author$project$Framework$FormField$newHelperText, model.H, 3, model.aQ),
				ad: mdgriffith$elm_ui$Element$Input$newPassword,
				I: _List_Nil,
				av: mdgriffith$elm_ui$Element$text('New Password'),
				U: model.x,
				ae: elm$core$Maybe$Just(author$project$Framework$FormField$OnEnter),
				bD: author$project$Framework$FormField$maybeShowHidePassword,
				af: author$project$Framework$FormField$OnChange,
				ag: author$project$Framework$FormField$OnFocus,
				ah: author$project$Framework$FormField$OnLoseFocus,
				aE: model.aR
...
var mdgriffith$elm_ui$Element$Input$currentPassword = F2(
	function (attrs, pass) {
		return A3(
			mdgriffith$elm_ui$Element$Input$textHelper,
			{
				l: elm$core$Maybe$Just('current-password'),
				n: false,
				r: mdgriffith$elm_ui$Element$Input$TextInputNode(
					pass.aE ? 'text' : 'password')
			},
	...
	return _Utils_Tuple2(
		A2(
				...
				]),
			{
				w: 4,
				Q: model.aN,
				ac: A3(author$project$Framework$FormField$newHelperText, model.H, 4, model.aN),
				ad: mdgriffith$elm_ui$Element$Input$currentPassword,
				I: _List_Nil,
				av: mdgriffith$elm_ui$Element$text('Current Password'),
				U: model.x,
				ae: elm$core$Maybe$Just(author$project$Framework$FormField$OnEnter),
				bD: author$project$Framework$FormField$maybeShowHidePassword,
				af: author$project$Framework$FormField$OnChange,
...
var mdgriffith$elm_ui$Element$Input$username = mdgriffith$elm_ui$Element$Input$textHelper(
	{
		l: elm$core$Maybe$Just('username'),
		n: false,
		r: mdgriffith$elm_ui$Element$Input$TextInputNode('text')
	});
	...
	return _Utils_Tuple2(
		A2(
				...
				]),
			{
				...
				Q: model._,
				ac: A3(author$project$Framework$FormField$newHelperText, model.H, 1, model._),
				ad: mdgriffith$elm_ui$Element$Input$username,
				I: _List_Nil,
				av: mdgriffith$elm_ui$Element$text('Username'),
				U: model.x,
				ae: elm$core$Maybe$Just(author$project$Framework$FormField$OnEnter),
				af: author$project$Framework$FormField$OnChange,
				ag: author$project$Framework$FormField$OnFocus,
		...
		return A2(
			...
			A2(
							...
							]) : _List_Nil)),
				{
						...
						_Utils_ap(
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											mdgriffith$elm_ui$Element$Font$typeface(author$project$Framework$Configuration$conf.a_.cV),
											author$project$Framework$Configuration$conf.a_.fy
										])),
									mdgriffith$elm_ui$Element$Font$size(16)
								]),
							labelIsAbove ? _List_Nil : _List_fromArray(
					...
					bI: A2(author$project$Framework$FormFieldWithPattern$Input, field, pattern),
					bJ: elm$core$Maybe$Nothing,
					fd: modelValue
				}));
	});
var author$project$Framework$FormFieldWithPattern$example1 = function (model) {
	return _Utils_Tuple2(
		A2(
			...
			model,
			{w: 0, a3: 'test', av: 'Phone number USA', a9: '(000) 000 - 0000'}),
...
var author$project$Framework$FormFieldWithPattern$example2 = function (model) {
	return _Utils_Tuple2(
		A2(
			author$project$Framework$FormFieldWithPattern$inputText,
			model,
			{w: 1, a3: 'test', av: 'Credit Card number', a9: '0000 - 0000 - 0000 - 0000'}),
...
var author$project$Framework$FormFieldWithPattern$example3 = function (model) {
	return _Utils_Tuple2(
		A2(
			author$project$Framework$FormFieldWithPattern$inputText,
			model,
			{w: 2, a3: 'test', av: '6 Digits Code', a9: '______'}),
...
var author$project$Framework$StyleElementsInput$example0 = function (_n0) {
	return _Utils_Tuple2(
		A2(
			...
			{
				av: mdgriffith$elm_ui$Element$text('Label'),
				aj: elm$core$Maybe$Just(author$project$Framework$StyleElementsInput$Button)
			}),
		'Input.button []\n    { label = text "Label"\n    , onPress = Just Button\n    }');
};
		...
		A2(
			...
			_List_Nil,
			{
				av: A2(
					...
					_List_Nil,
					mdgriffith$elm_ui$Element$text('Label')),
				bI: author$project$Framework$StyleElementsInput$Input,
				bJ: elm$core$Maybe$Nothing,
				fd: model.fd
			}),
...
var mdgriffith$elm_ui$Element$Input$multiline = F2(
	function (attrs, multi) {
		return A3(
			mdgriffith$elm_ui$Element$Input$textHelper,
			{l: elm$core$Maybe$Nothing, n: multi.cR, r: mdgriffith$elm_ui$Element$Input$TextArea},
			attrs,
			{av: multi.av, bI: multi.bI, bJ: multi.bJ, fd: multi.fd});
	});
		...
		A2(
			...
			_List_Nil,
			{
				...
				av: A2(
					...
					_List_Nil,
					mdgriffith$elm_ui$Element$text('Label')),
				bI: author$project$Framework$StyleElementsInput$Checkbox
			}),
				...
				switch (found) {
					case 0:
						return _Utils_eq(
							...
							input.cQ) ? _Utils_Tuple3(1, prev, nxt) : _Utils_Tuple3(found, val, nxt);
					case 1:
		...
		A2(
			...
			_List_Nil,
			{
				av: A2(
					...
					_List_Nil,
					mdgriffith$elm_ui$Element$text('Label')),
				bI: author$project$Framework$StyleElementsInput$Radio,
				eB: _List_fromArray(
					[
						A2(
						mdgriffith$elm_ui$Element$Input$option,
...
var mdgriffith$elm_ui$Element$Input$search = mdgriffith$elm_ui$Element$Input$textHelper(
	{
		l: elm$core$Maybe$Nothing,
		n: false,
		r: mdgriffith$elm_ui$Element$Input$TextInputNode('search')
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(author$project$Framework$sourceCodeWrapper, model.a, componentExampleSourceCodeToDisplay))
				]));
	});
...
var author$project$Framework$viewIntrospectionBody = F3(
	function (model, title, listSubSection) {
		return A2(
			...
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$padding(model.a.z),
					mdgriffith$elm_ui$Element$spacing(model.a.z),
					mdgriffith$elm_ui$Element$Background$color(
...
var mdgriffith$elm_ui$Element$Font$extraLight = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontWeight, mdgriffith$elm_ui$Internal$Style$classes.fg);
var author$project$Framework$viewIntrospectionTitle = F2(
	function (configuration, introspection) {
		var title = introspection.o;
		var subTitle = mdgriffith$elm_ui$Element$text(introspection.as);
		return A2(
			mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$Background$color(
					author$project$Color$toElementColor(configuration.bx)),
					mdgriffith$elm_ui$Element$padding(configuration.z),
					mdgriffith$elm_ui$Element$spacing(10),
					mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill)
				]),
			_List_fromArray(
...
var author$project$Framework$viewIntrospection = F2(
	function (model, introspection) {
		return A2(
			...
			A2(
				elm$core$List$cons,
				A2(author$project$Framework$viewIntrospectionTitle, model.a, introspection),
				A2(
					elm$core$List$map,
					function (_n0) {
						var string = _n0.a;
	...
	function (title, subTitle, version) {
		return A2(
			...
			_List_Nil,
			{
				...
				Z: author$project$Framework$routeToString(author$project$Framework$RouteHome)
			});
	});
	...
	function (model, _n0) {
		...
		return A2(
			...
			A2(
				...
				A2(author$project$Framework$viewIntrospectionTitle, model.a, introspection),
				_Utils_ap(
					(introspection.aF !== '') ? _List_fromArray(
						[
							A2(
							mdgriffith$elm_ui$Element$paragraph,
							_List_fromArray(
							...
							_List_fromArray(
								[
									...
									A2(
										elm$core$String$join,
										'⇾',
										A2(elm$core$String$split, '->', introspection.aF)))
								]))
						]) : _List_Nil,
					_List_fromArray(
						[
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$padding(model.a.z + 100),
							mdgriffith$elm_ui$Element$spacing(model.a.z)
						]),
					_List_fromArray(
						[
							...
							mdgriffith$elm_ui$Element$el,
							_List_Nil,
							A3(author$project$Framework$viewLogo, model.a.bh, model.a.bf, model.a.bi)),
							A2(
							mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
		...
		return A2(
			...
			function (_n0) {
				...
				return A2(
					...
					_List_Nil,
					{
						av: mdgriffith$elm_ui$Element$text(title),
						Z: author$project$Framework$routeToString(
							A2(author$project$Framework$RouteSubPage, introspection.o, title))
					});
			},
			variations);
	});
				...
				[
					...
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$pointer,
							mdgriffith$elm_ui$Element$Events$onClick(
							author$project$Framework$MsgToggleSection(introspection.o)),
							mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
							mdgriffith$elm_ui$Element$Font$bold
						]),
					A2(
						...
						_List_fromArray(
							[
								...
								mdgriffith$elm_ui$Element$text(introspection.o))
							]))),
					A2(
					mdgriffith$elm_ui$Element$column,
					_Utils_ap(
						_List_fromArray(
							[
								...
								mdgriffith$elm_ui$Element$Font$size(16),
								mdgriffith$elm_ui$Element$Font$color(
								author$project$Color$toElementColor(configuration.bw)),
								mdgriffith$elm_ui$Element$spacing(8),
								mdgriffith$elm_ui$Element$paddingEach(
								{bo: 1, bB: 26, bL: 0, bT: 12}),
								mdgriffith$elm_ui$Element$clip
							]),
					...
					A2(author$project$Framework$viewListVariationForMenu, introspection, introspection.an))
				]));
	});
var author$project$Framework$viewMenuColumn = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$Background$color(
				author$project$Color$toElementColor(model.a.au)),
				mdgriffith$elm_ui$Element$Font$color(
				author$project$Color$toElementColor(model.a.bv)),
				mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
				mdgriffith$elm_ui$Element$height(mdgriffith$elm_ui$Element$shrink),
				mdgriffith$elm_ui$Element$spacing(30),
				A2(mdgriffith$elm_ui$Element$paddingXY, model.a.z, model.a.z),
				mdgriffith$elm_ui$Element$height(mdgriffith$elm_ui$Element$fill)
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A3(author$project$Framework$viewLogo, model.a.bS, model.a.bf, model.a.bi)
					])),
				A2(
				mdgriffith$elm_ui$Element$column,
				_List_fromArray(
				...
				A2(
					...
					function (_n0) {
						var data = _n0.a;
						var show = _n0.b;
						return A3(author$project$Framework$viewIntrospectionForMenu, model.a, data, show);
					},
					model.m))
			]));
};
var mdgriffith$elm_ui$Element$clipX = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$overflow, mdgriffith$elm_ui$Internal$Style$classes.dB);
				...
				[
					...
					function () {
						if (!maybeWindowSize.$) {
							...
							return mdgriffith$elm_ui$Element$px(windowSize.T);
						} else {
...
var mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
				...
				case 0:
					...
					if (_n4.$ === 1) {
						return _Utils_update(
							record,
							{
								d2: elm$core$Maybe$Just(hoverable)
							});
					} else {
						return record;
					}
				case 1:
					...
					if (_n5.$ === 1) {
						return _Utils_update(
							record,
							{
								at: elm$core$Maybe$Just(focusStyle)
							});
					} else {
						return record;
					}
	...
	return andFinally(
		A3(
			elm$core$List$foldr,
			combine,
			{at: elm$core$Maybe$Nothing, d2: elm$core$Maybe$Nothing, er: elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[mdgriffith$elm_ui$Internal$Style$classes.eU, mdgriffith$elm_ui$Internal$Style$classes.db, mdgriffith$elm_ui$Internal$Style$classes.e$]))),
...
var author$project$Framework$view = function (model) {
	return A3(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$Font$external(
						{o: author$project$Framework$Configuration$conf.a_.cV, Z: author$project$Framework$Configuration$conf.a_.Z}),
						mdgriffith$elm_ui$Element$Font$typeface(author$project$Framework$Configuration$conf.a_.cV),
						author$project$Framework$Configuration$conf.a_.fy
					])),
				mdgriffith$elm_ui$Element$Font$size(16),
		...
		A2(author$project$Framework$viewPage, model.a8, model));
};
...
var author$project$FrameworkCustomized$main = elm$browser$Browser$element(
	{ea: author$project$FrameworkCustomized$init, fb: author$project$Framework$subscriptions, fA: author$project$Framework$update, fB: author$project$FrameworkCustomized$view});
					...
					return A2(
						...
						function (height) {
							return elm$json$Json$Decode$succeed(
								{T: height, bC: locationHref, ap: width});
						},
