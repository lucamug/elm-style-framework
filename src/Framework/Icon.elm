module Framework.Icon exposing (icon, introspection)
...
introspection =
    ...
    , usageResult = icon.pencil color.black 32
    , boxed = True
    , variations =
        [ ( "Icons"
          , [ ( icon.pencil color.black 32, "icon.pencil color.black 32" )
            , ( icon.exitFullscreen color.black 32, "icon.exitFullscreen color.black 32" )
            , ( icon.fullscreen color.black 32, "icon.fullscreen color.black 32" )
            , ( icon.home color.black 32, "icon.home color.black 32" )
            , ( icon.hide color.black 32, "icon.hide color.black 32" )
            , ( icon.show color.black 32, "icon.show color.black 32" )
            , ( icon.mobileRinging color.black 32, "icon.mobileRinging color.black 32" )
            , ( icon.mobileNotification color.black 32, "icon.mobileNotification color.black 32" )
            , ( icon.mobileNotification2 color.black 32, "icon.mobileNotification2 color.black 32" )
            , ( icon.chevronDown color.black 32, "icon.chevronDown color.black 32" )
            , ( icon.arrows color.black 32, "icon.arrows color.black 32" )
            ]
          )
        ]
    }
...
icon :
    ...
    , chevronDown : Color.Color -> Int -> Element.Element msg1
    , exitFullscreen : Color.Color -> Int -> Element.Element msg2
    , fullscreen : Color.Color -> Int -> Element.Element msg3
    , hide : Color.Color -> Int -> Element.Element msg4
    , home : Color.Color -> Int -> Element.Element msg5
    , mobileNotification : Color.Color -> Int -> Element.Element msg6
    , mobileNotification2 : Color.Color -> Int -> Element.Element msg7
    , mobileRinging : Color.Color -> Int -> Element.Element msg8
    , pencil : Color.Color -> Int -> Element.Element msg9
    , show : Color.Color -> Int -> Element.Element msg10
    }
icon =
    { pencil = \color size -> Element.html <| pencil color size
    , exitFullscreen = \color size -> Element.html <| exitFullscreen color size
    , fullscreen = \color size -> Element.html <| fullscreen color size
    , home = \color size -> Element.html <| home color size
    , hide = \color size -> Element.html <| hide color size
    , show = \color size -> Element.html <| show color size
    , mobileRinging = \color size -> Element.html <| mobileRinging color size
    , mobileNotification = \color size -> Element.html <| mobileNotification color size
    , mobileNotification2 = \color size -> Element.html <| mobileNotification2 color size
    , chevronDown = \color size -> Element.html <| chevronDown color size
    , arrows = \color size -> Element.html <| arrows color size
    }


arrows : Color.Color -> Int -> Html msg
arrows _ size =
...
home : Color.Color -> Int -> Html.Html msg
home _ size =
...
pencil : Color.Color -> Int -> Html.Html msg
pencil _ size =
...
exitFullscreen : Color.Color -> Int -> Html.Html msg
...
fullscreen : Color.Color -> Int -> Html.Html msg
fullscreen _ size =
...
mobileNotification2 : Color.Color -> Int -> Html msg
mobileNotification2 color size =
...
mobileRinging : Color.Color -> Int -> Html msg
mobileRinging color size =
    let
        hexColor =
            Framework.Color.colorToHex color
    in
...
mobileNotification : Color.Color -> Int -> Html msg
mobileNotification color size =
    Svg.svg [ SA.viewBox "0 0 60 60", SA.height <| toString size ]
        [ Svg.path [ SA.fill (Framework.Color.colorToHex color), SA.d "M20 49a4 4 0 1 0 0 8 4 4 0 0 0 0-8zm0 6a2 2 0 1 1 0-4 2 2 0 0 1 0 4zM17 5h4a1 1 0 1 0 0-2h-4a1 1 0 1 0 0 2zm7 0h1a1 1 0 1 0 0-2h-1a1 1 0 1 0 0 2z" ] []
        , Svg.path [ SA.fill (Framework.Color.colorToHex color), SA.d "M56 12H38V4c0-2-2-4-4-4H8C6 0 4 2 4 4v52c0 2 2 4 4 4h26c2 0 4-2 4-4V33h18V12zM8 2h26l2 2v2H6V4l2-2zm26 56H8l-2-2v-8h30v8l-2 2zm2-12H6V8h30v4H18v21h4v7l9-7h5v13zm18-15H31l-7 5v-5h-4V14h34v17z" ] []
        , Svg.path [ SA.fill (Framework.Color.colorToHex color), SA.d "M25 21h10a1 1 0 1 0 0-2H25a1 1 0 1 0 0 2zm-1 4l1 1h24a1 1 0 1 0 0-2H25l-1 1z" ] []
        ]


chevronDown : Color.Color -> Int -> Html msg
chevronDown _ size =
